...
const Ingredients = () => {
  ...
  const removeItemHandler = (ingredientId) => {
    setIsLoading(true);
    fetch(`https://react-hooks-update-43e88-default-rtdb.firebaseio.com/ingredients/${ingredientId}.jon`,{
      method: 'DELETE'
    }).then(response => {  
      setIsLoading(false);
      setUserIngredients( prevIngredients => 
  ...
  return (
    <div className="App">
      ...
      <IngredientForm onAddIgredient={addIngredientHandler} loading={isLoading}/>
      <section>
